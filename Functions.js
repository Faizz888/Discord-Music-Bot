module.exports = {
  ...
  async Objector(Song, message) {
    ...
    async function FC(Count) {
      if (Count.length === 4) {
        return `${Count[0]} тысяч`;
      } else if (Count.length === 5) {
        return `${Count[0]}${Count[1]} тысяч`;
      } else if (Count.length === 6) {
        return `${Count[0]}${Count[1]}${Count[2]} тысяч`;
      } else if (Count.length === 7) {
        return `${Count[0]} Миллион`;
      } else if (Count.length === 8) {
        return `${Count[0]}${Count[1]} миллион`;
      } else if (Count.length === 9) {
        return `${Count[0]}${Count[1]}${Count[2]} миллион`;
      } else if (Count.length === 10) {
        return `${Count[0]} миллиард`;
      } else if (Count.length === 11) {
        return `${Count[0]}${Count[1]} миллиард`;
      } else if (Count.length === 12) {
        return `${Count[0]}${Count[1]}${Count[2]} миллиард`;
      } else if (Count.length === 13) {
        return `${Count[0]} триллион`;
      } else {
        return Count;
      }
    };
